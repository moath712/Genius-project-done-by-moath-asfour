...
class learning_6 extends StatefulWidget {
  learning_6({Key? key}) : super(key: key);

  @override
  State<learning_6> createState() => _SliderPState();
}

class _SliderPState extends State<learning_6> {
  int activeIndex = 0;
