...
class learning_4 extends StatefulWidget {
  learning_4({Key? key}) : super(key: key);

  @override
  State<learning_4> createState() => _SliderPState();
}

class _SliderPState extends State<learning_4> {
  int activeIndex = 0;
